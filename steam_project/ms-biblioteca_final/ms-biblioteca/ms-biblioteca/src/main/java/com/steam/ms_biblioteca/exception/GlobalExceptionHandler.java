package com.steam.ms_biblioteca.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleFeign(FeignException ex) {
        ...
        // Cualquier otro error de Feign se trata como servicio no disponible
        return buildError(HttpStatus.SERVICE_UNAVAILABLE,
                "Un servicio externo no está disponible. Intente más tarde.");
    }
